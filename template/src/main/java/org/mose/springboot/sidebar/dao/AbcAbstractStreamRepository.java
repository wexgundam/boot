...
import org.mose.springboot.sidebar.dao.stream.AbstractStreamRepository;
 ...
 */
@Repository
public class AbcAbstractStreamRepository extends AbstractStreamRepository<Abc, String> {
