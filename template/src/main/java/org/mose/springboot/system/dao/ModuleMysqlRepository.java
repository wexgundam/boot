...
public class ModuleMysqlRepository extends AbstractStreamRepository<Module, Integer> implements IModuleRepository {
    ...
    public Integer insertOne(Module module) {
        ...
        sql.append(" values(:name, :description, :parentId, :scenarioId, :icon, :order)");
    ...
    public int updateOne(Module module) {
        StringBuffer sql = new StringBuffer();
        sql.append("update T_MODULE set name=:name, description=:description, parent_id=:parentId, scenario_id=:scenarioId, icon=:icon, display_order=:order");
