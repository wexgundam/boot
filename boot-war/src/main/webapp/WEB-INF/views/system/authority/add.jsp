...
<body>
    ...
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title"> 新建权限
        <small>新建权限，设置权限属性、密码等基本信息</small>
    </h1>
    <!-- END PAGE TITLE-->
    ...
    <div class="row">
        <div class="col-xs-12">
            <form id="scenarioForm" name="scenarioForm" class="form-horizontal" role="form" action="${dynamicResourceServerUrl}/system/authority/add.htm" method="post">
                <div class="form-body">
                    <div class="form-group">
                        <label class="col-md-3 control-label">权限名称</label>
                        <div class="col-md-9">
                            <input name="name" type="text" class="form-control input-xlarge" placeholder="输入权限名称">
